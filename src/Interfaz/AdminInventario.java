...
public class AdminInventario extends javax.swing.JDialog {
    ...
    String passw="";
    public AdminInventario(Menu parent, boolean modal) {
        super(parent, modal);
        this.parent=parent;
      ...
      try{
          if(jPcontraseña.getText().equals("") || jtusuario.getText().equals(""))
          {
    		...
    		Class.forName("com.mysql.jdbc.Driver");
                try (Connection conexion = DriverManager.getConnection("jdbc:mysql://sql10.freesqldatabase.com:3306/sql10292471", "sql10292471", "5smwscQGBg")) {
        ...
        Registro regis=new Registro(null,true);
        regis.setSize(1150,650);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdminInventario dialog = new AdminInventario(new Menu(), true);
